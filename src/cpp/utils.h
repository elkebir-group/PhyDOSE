...
typedef lemon::MaxMatching<Graph> MaxMatching;
typedef std::vector<Graph::Edge> EdgeVector;
typedef lemon::ListGraph::EdgeIt EdgeIt;
typedef lemon::concepts::BpGraph Bpgraph;
typedef lemon::Dfs<Digraph> Dfs;
typedef lemon::Dfs<Graph> Dfsg;
typedef std::map<Node, int> NodetoInt;
typedef std::map<Graph::Edge, int> EdgetoInt;
//typedef PredMapPath<Digraph, TR::PredMap> Path;
